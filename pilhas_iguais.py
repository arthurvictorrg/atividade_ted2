...
Original file is located at
    https://colab.research.google.com/drive/1YDd26rUb2QL3zMamU461oeursKmuZamx
"""
...
class PilhasIguais:
        ...
        def comparar_pilhas(self):
            if(self.capacidade1 != self.capacidade2):
                return "As pilhas não são iguais, capacidade diferente."
            if(self.capacidade1 == self.capacidade2):
                if (self.valores1 == self.valores2).all():
                    return "São iguais!"
                else:
                    return "As pilhas não são iguais, valores são diferentes."
